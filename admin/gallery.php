			...
			<form action="" id="manage-gallery">
				<div class="card">
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm bg-maroon text-white col-sm-3 offset-md-3"> Save</button>
								<button class="btn btn-sm btn-dark col-sm-3" type="button" onclick="$('#manage-gallery').get(0).reset()"> Cancel</button>
							</div>
						</div>
					</div>
				</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm bg-maroon text-white edit_gallery" type="button" data-id="<?php echo $row['id'] ?>" data-about="<?php echo $row['about'] ?>" data-src="<?php echo isset($img[$row['id']]) && is_file($fpath.'/'.$img[$row['id']]) ? $fpath.'/'.$img[$row['id']] :'' ?>" >Edit</button>
										<button class="btn btn-sm btn-dark delete_gallery" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
