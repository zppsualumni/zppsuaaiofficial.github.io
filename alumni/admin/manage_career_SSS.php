...
<?php
if(isset($_GET['id'])){
$qry = $conn->query("SELECT * FROM careers where id= ".$_GET['id']);
				...
				<form action="" id="manage-career">
					...
					<div class="form-group row">
						<div class="col-md-5">
							...
							<input type="text" class="form-control" name="company"  value="<?php echo isset($company) ? $company :'' ?>" required>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-5">
					...
					<div class="form-group row">
						<div class="col-md-5">
							...
							<input type="text" class="form-control" name="job_title"  value="<?php echo isset($job_title) ? $job_title :'' ?>" required>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-10">
