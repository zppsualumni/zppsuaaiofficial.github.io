			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header bg-maroon text-white">
						Jobs List
						<span class="">
							<button class="btn btn-white btn-block btn-sm col-sm-2 float-right" type="button" id="new_career">New Job</button>
						</span>
					</div>
					<div class="card-body">
								...
								<tr>
									...
									<center>
										<div class="btn-group">
											...
											<a class="dropdown-item edit_career" href="javascript:void(0)" data-id = '<?php echo $row['id'] ?>'>Edit</a>
											<div class="dropdown-divider"></div>
											<a class="dropdown-item delete_career" href="javascript:void(0)" data-id = '<?php echo $row['id'] ?>'>Delete</a>
											</div>
										</div>
									</center>									</td>
								</tr>
